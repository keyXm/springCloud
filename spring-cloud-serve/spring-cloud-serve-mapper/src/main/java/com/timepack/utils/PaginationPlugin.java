...
public  class PaginationPlugin extends PluginAdapter {
	...
	public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
		...
		FullyQualifiedJavaType imp = new FullyQualifiedJavaType("BaseDao");
...
//		addSerialVersionUID(topLevelClass, introspectedTable);
	...
	public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
		...
		for (IntrospectedColumn introspectedColumn : introspectedTable.getAllColumns()) {
            ...
            if("varchar".equalsIgnoreCase(introspectedColumn.getJdbcTypeName())){
            	sb.append(" != null and "+introspectedColumn.getJavaProperty()+" !=''"); //$NON-NLS-1$
            }else{
            	sb.append(" != null");
            }
	...
	public static void generate() {
		String config = MyCommentGenerator.class.getClassLoader().getResource("generatorConfig.xml").getFile();
